import{_ as n,o as s,c as a,e}from"./app.ebc37b2a.js";const t="/assets/组件更新.3912dbb8.png",p={},l=e(`<h1 id="setstate" tabindex="-1"><a class="header-anchor" href="#setstate" aria-hidden="true">#</a> setState</h1><h2 id="更新数据" tabindex="-1"><a class="header-anchor" href="#更新数据" aria-hidden="true">#</a> 更新数据</h2><ul><li>setState() 是异步更新数据的</li><li>注意：使用该语法时，后面的 setState() 不要依赖于前面的 setState()</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token number">1.</span> 当你调用 setState 的时候，React<span class="token punctuation">.</span>js 并不会马上修改 state （为什么）
